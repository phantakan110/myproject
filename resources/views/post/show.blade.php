                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $post->title }} </td></tr><tr><th> Content </th><td> {{ $post->content }} </td></tr><tr><th> Year </th><td> {{ $post->year }} </td></tr><tr><th> Price </th><td> {{ $post->price }} </td></tr><tr><th> Isbn </th><td> {{ $post->isbn }} </td></tr><tr><th> Author Id </th><td> {{ $post->author_id }} </td></tr><tr><th> Publisher Id </th><td> {{ $post->publisher_id }} </td></tr><tr><th> Photo </th><td> {{ $post->photo }} </td></tr>
                                </tbody>
                            </table>
                        </div>
